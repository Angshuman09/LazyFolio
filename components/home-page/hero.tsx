...
const Hero = () => {
  ...
  return (
    <section className="home-hero max-w-5xl mx-auto px-5 sm:px-8 text-center mt-24 mb-10">
      ...
      <div className="fade-up fade-up-3 flex flex-col sm:flex-row items-stretch justify-center gap-2.5 sm:gap-3 w-full px-4 sm:px-0 max-w-105 mx-auto mb-10 mt-17">
        <label className="flex items-center w-full sm:flex-1 sm:min-w-0 h-13 sm:h-12 rounded-full border border-(--lf-border) bg-(--lf-surface) px-4 sm:px-5 gap-1 sm:gap-1.5 transition-colors duration-150 focus-within:border-(--lf-tan) cursor-text">
        ...
        <button
          ...
          className="group inline-flex disabled:cursor-not-allowed disabled:opacity-40 items-center justify-center gap-2 w-full sm:w-auto h-12 bg-(--lf-ink) text-(--lf-bg) text-[0.8125rem] sm:text-[0.875rem] font-semibold px-6 rounded-full hover:opacity-85 active:scale-[0.97] transition-all duration-150 cursor-pointer whitespace-nowrap shrink-0"
        >
