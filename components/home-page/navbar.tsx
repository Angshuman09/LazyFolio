          ...
          {session?.user ? (
            <>
              <Button
                ...
                className="bg-(--lf-ink) text-(--lf-surface) hover:cursor-pointer border-2 border-(--lf-ink) text-[0.8rem] font-semibold px-5 py-2 rounded-xl hover:opacity-80 transition-opacity flex items-center gap-1.5"
              >
                Dashboard
              </Button>
