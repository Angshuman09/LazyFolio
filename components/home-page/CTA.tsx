    ...
    >
      <div className="bg-(--lf-surface) border border-(--lf-border) text-(--lf-ink) rounded-2xl px-6 sm:px-12 py-16 text-center shadow-[0_30px_70px_-30px_rgba(0,0,0,0.15)] dark:shadow-[0_30px_70px_-30px_rgba(0,0,0,0.7)]">
        ...
        <button
          ...
          className="lf-focus group inline-flex rounded-full items-center gap-2 bg-(--lf-ink) text-(--lf-bg) border border-(--lf-ink) text-[0.88rem] font-semibold px-6 py-3.5 transition-all duration-150 hover:opacity-85 hover:shadow-lg hover:shadow-black/10 active:scale-[0.97] cursor-pointer"
        >
          Start for free
          <span
            aria-hidden="true"
