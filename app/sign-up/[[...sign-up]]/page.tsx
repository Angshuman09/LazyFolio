    ...
    <div className="min-h-screen bg-(--lf-bg) flex items-center justify-center px-4 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="relative z-10 w-full flex flex-col items-center gap-6">
        ...
        <div className="text-center mb-2">
          <p className="font-display text-3xl font-bold tracking-tight text-(--lf-ink) transition-colors duration-300">
            Lazyfolio
          </p>
        ...
        {/* Clerk SignUp with delayed mount to prevent ignoring appearance update */}
